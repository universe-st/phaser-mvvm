...
| 你是谁 / 要做什么                           | 按这个顺序读                                                                                               |
| ------------------------------------------- | ---------------------------------------------------------------------------------------------------------- |
| 第一次接触，想先看到画面                    | [01 快速开始](./01-quick-start.md) → [02 布局](./02-layout.md) → [03 控件](./03-widgets.md)                |
| 想要 Jetpack Compose 那样的写法             | [09 Compose 风格 DSL](./09-compose-dsl.md)（可运行示例：`#/compose`）                                      |
...
| 章节                                                        | 你会做出什么                                      | 涉及的核心概念                                                                  |
| ----------------------------------------------------------- | ------------------------------------------------- | ------------------------------------------------------------------------------- |
| [01 快速开始](./01-quick-start.md)                          | 一个能跑的页面：标题 + 两张卡片 + 一个按钮        | 游戏配置、`MVVMPlugin`、工厂注册、`this.mvvm.mount()`、帧对齐刷新               |
