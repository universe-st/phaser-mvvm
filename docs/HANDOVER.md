...
| 检查     | 结果                                                                                                                                                                                                                           | 怎么复现                                                                                                                       |
| -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------ |
| 单测     | **1411 passed**：core 281、layout 314、phaser 420、widgets 396（第 113 轮 +13：`test/focus-visible.test.ts` 的焦点可见性用例；第 110 轮那 +16 见下表）                                                                         | `pnpm -r run test`                                                                                                             |
